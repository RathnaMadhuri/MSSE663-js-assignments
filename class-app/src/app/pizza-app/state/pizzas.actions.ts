...
import {PizzaEntity, Pizza} from 'api/lib/api-interfaces';
...
export const savePizzas = createAction('[Pizzas] Save Pizza',
props<{pizzas: PizzaForm[]}>()
);

export const savePizzasSuccess = createAction('[Pizzas] Save Pizzas Success',
    props<{pizzas: PizzaEntity[]}>()
);
export const savePizzasFailure = createAction('[Pizzas] Save Pizzas Failure',
    props<{error: any}>()
);
